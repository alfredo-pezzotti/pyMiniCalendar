...
from libs.Xlib.protocol import display, request, event, rq

# Xlib.xobjects modules
import libs.Xlib.xobject.resource
import libs.Xlib.xobject.drawable
import libs.Xlib.xobject.fontable
import libs.Xlib.xobject.colormap
import libs.Xlib.xobject.cursor

_resource_baseclasses = {
    'resource': libs.Xlib.xobject.resource.Resource,
    'drawable': libs.Xlib.xobject.drawable.Drawable,
    'window': libs.Xlib.xobject.drawable.Window,
    'pixmap': libs.Xlib.xobject.drawable.Pixmap,
    'fontable': libs.Xlib.xobject.fontable.Fontable,
    'font': libs.Xlib.xobject.fontable.Font,
    'gc': libs.Xlib.xobject.fontable.GC,
    'colormap': libs.Xlib.xobject.colormap.Colormap,
    'cursor': libs.Xlib.xobject.cursor.Cursor,
    }
